...
%elevator(l3_ele1). % Already commented out
%elevator(l3_ele2). % Already commented out

%location(E) :- elevator(E). % Already commented out
location(R) :- room(R).
...
door(d3_432).
door(d3_436).
%door(d3_436a). % Already commented out
%door(d3_436b). % Already commented out
...
%door(d3_ele1). % Already commented out
%door(d3_ele2). % Already commented out

%hasdoor(l3_ele1, d3_ele1). % Already commented out
%hasdoor(l3_200, d3_ele1).  % Already commented out
%hasdoor(l3_ele2, d3_ele2). % Already commented out
%hasdoor(l3_200, d3_ele2).  % Already commented out
